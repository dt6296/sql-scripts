...
SELECT DISTINCT myCTE.*, SecurityData.*  FROM myCTE
...
WHERE 
sghx.SecurityGroupID = @SecurityGroup --40
...
AND (h.HierarchyRoot LIKE (@Module + '%') --
OR h.HierarchyRoot = '' )
...
SELECT 
'a' +
CASE WHEN LEN(108) = 4 THEN CAST(108 AS CHAR(4)) ELSE
CASE WHEN LEN(108) = 3 THEN CAST('0' AS CHAR(1)) + CAST(108 AS CHAR(3)) ELSE
CASE WHEN LEN(108) = 2 THEN CAST('00' AS CHAR(2)) + CAST(108 AS CHAR(2)) ELSE
CASE WHEN LEN(108) = 1 THEN CAST('000' AS CHAR(3)) + CAST(108 AS CHAR(1)) END END END END +
'a' +
CASE WHEN LEN(95) = 4 THEN CAST(95 AS CHAR(4)) ELSE
CASE WHEN LEN(95) = 3 THEN CAST('0' AS CHAR(1)) + CAST(95 AS CHAR(3)) ELSE
CASE WHEN LEN(95) = 2 THEN CAST('00' AS CHAR(2)) + CAST(95 AS CHAR(2)) ELSE
CASE WHEN LEN(95) = 1 THEN CAST('000' AS CHAR(3)) + CAST(95 AS CHAR(1)) END END END END AS LENTEST

--------------------------------------------

SELECT
'a' +
CASE WHEN LEN(1) = 4 THEN CAST(1 AS CHAR(4)) ELSE
CASE WHEN LEN(1) = 3 THEN CAST('0' AS CHAR(1)) + CAST(1 AS CHAR(3)) ELSE
CASE WHEN LEN(1) = 2 THEN CAST('00' AS CHAR(2)) + CAST(1 AS CHAR(2)) ELSE
CASE WHEN LEN(1) = 1 THEN CAST('000' AS CHAR(3)) + CAST(1 AS CHAR(1)) END END END END AS LENTEST

SELECT
'a' +
CASE WHEN LEN(12) = 4 THEN CAST(12 AS CHAR(4)) ELSE
CASE WHEN LEN(12) = 3 THEN CAST('0' AS CHAR(1)) + CAST(12 AS CHAR(3)) ELSE
CASE WHEN LEN(12) = 2 THEN CAST('00' AS CHAR(2)) + CAST(12 AS CHAR(2)) ELSE
CASE WHEN LEN(12) = 1 THEN CAST('000' AS CHAR(3)) + CAST(12 AS CHAR(1)) END END END END AS LENTEST

SELECT
'a' +
CASE WHEN LEN(123) = 4 THEN CAST(123 AS CHAR(4)) ELSE
CASE WHEN LEN(123) = 3 THEN CAST('0' AS CHAR(1)) + CAST(123 AS CHAR(3)) ELSE
CASE WHEN LEN(123) = 2 THEN CAST('00' AS CHAR(2)) + CAST(123 AS CHAR(2)) ELSE
CASE WHEN LEN(123) = 1 THEN CAST('000' AS CHAR(3)) + CAST(123 AS CHAR(1)) END END END END AS LENTEST

SELECT
'a' +
CASE WHEN LEN(1234) = 4 THEN CAST(1234 AS CHAR(4)) ELSE
CASE WHEN LEN(1234) = 3 THEN CAST('0' AS CHAR(1)) + CAST(1234 AS CHAR(3)) ELSE
CASE WHEN LEN(1234) = 2 THEN CAST('00' AS CHAR(2)) + CAST(1234 AS CHAR(2)) ELSE
CASE WHEN LEN(1234) = 1 THEN CAST('000' AS CHAR(3)) + CAST(1234 AS CHAR(1)) END END END END AS LENTEST
...
SELECT
m.ModuleID, m.MainTableID, t.TableName,
'a' +
CASE WHEN LEN(m.MainTableID) = 4 THEN CAST(m.MainTableID AS CHAR(4)) ELSE
CASE WHEN LEN(m.MainTableID) = 3 THEN CAST('0' AS CHAR(1)) + CAST(m.MainTableID AS CHAR(3)) ELSE
CASE WHEN LEN(m.MainTableID) = 2 THEN CAST('00' AS CHAR(2)) + CAST(m.MainTableID AS CHAR(2)) ELSE
CASE WHEN LEN(m.MainTableID) = 1 THEN CAST('000' AS CHAR(3)) + CAST(m.MainTableID AS CHAR(1)) END END END END AS HRoot

FROM DDModules AS m
INNER JOIN DDTables AS t ON m.MainTableID = t.TableID
